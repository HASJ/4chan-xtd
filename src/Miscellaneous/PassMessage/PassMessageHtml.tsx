...
const passMessagePage = <div class="box-inner">
  <div class="boxbar">
    <h2>
      ...
      <button type="button" class="close-button" style="background: none; border: none; padding: 0; cursor: pointer; font: inherit; color: inherit; text-decoration: none; float: right; margin-right: 4px;" title="Close">×</button>
    </h2>
  </div>
